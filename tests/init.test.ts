...
describe("getInitDeps", () => {
  ...
  it("adds vite-css-modules only when CSS Modules are detected", () => {
    expect(getInitDeps(false, "node", undefined, true)).toContain("vite-css-modules");
    expect(getInitDeps(false, "node", undefined, true)).toContain("postcss");
    expect(getInitDeps(false, "node", undefined, false)).not.toContain("vite-css-modules");
    expect(getInitDeps(false, "node", undefined, false)).not.toContain("postcss");
  });
});
